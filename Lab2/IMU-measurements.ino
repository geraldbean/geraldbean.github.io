...
void loop()
{
    ...
    if (IMU.accelerationAvailable())
    {
        ...
        Serial.print(a_x - 0.0075);
        Serial.print("\t");
        Serial.print(a_y + 0.04);
        Serial.print("\t");
        Serial.print(a_z - 0.00708);
        Serial.print(" g\t\t");
    }
    ...
    if (IMU.gyroscopeAvailable())
    {
        ...
        Serial.print(omega_x - 0.30208);
        Serial.print("\t");
        Serial.print(omega_y + 0.1633);
        Serial.print("\t");
        Serial.print(omega_z - 0.26917);
        Serial.print(" deg/s\n");
    }
}